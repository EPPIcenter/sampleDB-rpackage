...
MoveTubes <- function(barcode_file, barcode_type, longitudinal, plate_id, location, study_short_code){
  ...
  #FOR NEW TUBES UPLOAD LIKE NORMAL
  #FOR OLD TUBES FIND WHERE THEY ARE NOW, DELETE THEM FROM THAT PLACE AND ADD THEM LIKE NEW TUBES
