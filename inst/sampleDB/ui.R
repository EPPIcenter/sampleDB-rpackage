           ...
           tabPanel("Micronix Form",
                    ...
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        textInput("UploadMicronixPlateID", label = "Plate Name"),
           ...
           tabPanel("Cryovile Form",
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        fluidRow(column(width = 12,
                                        actionButton("UploadCryoAction", label = "Upload Samples", style="color: #fff; background-color: #337ab7; border-color: #2e6da4"),
           ...
           tabPanel("RDT Form",
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        fluidRow(column(width = 12,
                                        actionButton("UploadRDTAction", label = "Upload Samples", style="color: #fff; background-color: #337ab7; border-color: #2e6da4"),
           ...
           tabPanel("Paper Form",
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        fluidRow(column(width = 12,
                                        actionButton("UploadActionPaperSamples", label = "Upload Samples", style="color: #fff; background-color: #337ab7; border-color: #2e6da4"),
                      ...
                      mainPanel(
                        ...
                        fluidRow(
                          column(width = 4),
                          column(width = 4,
                        span(verbatimTextOutput("ExampleUploadPaperCSVNoDate"), style ="max-width: 50px; text-align: center"),
                          )),
                        HTML("<h5>The combination of <code>study_subject</code>, <code>specimen_type</code> and <code>study_code</code> must be unique.
                             Consider adding a collection_date for the sample</h5>"),
                        HTML("<h4><b>Longitudinal Data</b></h4>"),
                      ...
                      tabPanel("Freezers",
                               sidebarLayout(
                                 sidebarPanel(
                                   ...
                                   textInput("RenameFreezerType2", label = NULL, placeholder = "New Name"),
                                   textInput("RenameFreezerLevelI2", label = NULL, placeholder = "New Name"),
                                   textInput("RenameFreezerLevelII2", label = NULL, placeholder = "New Name"),
