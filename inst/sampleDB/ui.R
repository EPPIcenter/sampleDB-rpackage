           ...
           tabPanel("Micronix Samples",
                    ...
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        hr(),
                        fileInput("UploadDataSet", "Upload a UploadMicronixCSV File", multiple = FALSE, accept = c("text/csv", "text/comma-separated-values,text/plain", ".csv")),
                        ...
                        selectInput("UploadLocation", label = "Storage Location", choices = c("", sampleDB::CheckTable(database = database, "location")$location_name)),
                        selectInput("UploadLocationMatrixLevelI", label = HTML("<h5>Level I</h5>"), width = '25%', choices = c("", sampleDB::CheckTable(database = database, "location")$location_name)),
                        selectInput("UploadLocationMatrixLevelII", label = HTML("<h5>Level II</h5>"), width = '25%', choices = c("", sampleDB::CheckTable(database = database, "location")$location_name)),
           ...
           tabPanel("Cryo Samples",
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        hr(),
                        fileInput("UploadCryoSamples", "Upload a UploadCryoCSV File", multiple = FALSE, accept = c("text/csv", "text/comma-separated-values,text/plain", ".csv")),
                        textInput("UploadBoxID", label = "Unique Box Name"), 
                        ...
                        selectInput("UploadLocationCryoLevelI", label = HTML("<h5>Level I</h5>"), width = '25%', choices = c("", sampleDB::CheckTable(database = database, "location")$location_name)),
                        selectInput("UploadLocationCryoLevelII", label = HTML("<h5>Level II</h5>"), width = '25%', choices = c("", sampleDB::CheckTable(database = database, "location")$location_name)),
                        fluidRow(column(width = 12, 
           ...
           tabPanel("RDT Samples",
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        hr(),
                        fileInput("UploadRDTSamples", "Upload a UploadRDTCSV File", multiple = FALSE, accept = c("text/csv", "text/comma-separated-values,text/plain", ".csv")),
                        textInput("UploadBagID", label = "Unique Bag Name"),
                        ...
                        fluidRow(column(width = 12,
                                        actionButton("UploadActionRDTSamples", label = "Upload Dataset", style="color: #fff; background-color: #337ab7; border-color: #2e6da4"),
                                        actionButton("ClearUploadFormRDTSamples", label = "Clear Form"))),
                      ),
                      mainPanel(
                        width = 9,
           ...
           tabPanel("Paper Samples",
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        hr(),
                        fileInput("UploadPaperSamples", "Upload a UploadPaperCSV File", multiple = FALSE, accept = c("text/csv", "text/comma-separated-values,text/plain", ".csv")),
                        textInput("UploadBagID2", label = "Unique Bag Name"),
