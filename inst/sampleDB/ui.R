           ...
           tabPanel("Micronix Samples",
                    ...
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        hr(),
                        fileInput("UploadDataSet", "Upload a UploadMicronixCSV CSV", multiple = TRUE, accept = c("text/csv", "text/comma-separated-values,text/plain", ".csv")),
           ...
           tabPanel("Cryo Samples",
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        hr(),
                        fileInput("UploadCryoSamples", "Upload a UploadCryoCSV CSV", multiple = TRUE, accept = c("text/csv", "text/comma-separated-values,text/plain", ".csv")),
                      ...
                      tabPanel("Freezers",
                               sidebarLayout(
                                 sidebarPanel(
                                   ...
                                   selectInput("RenameFreezer1", label = "Current Name", choices = c("", sampleDB::CheckTable(database = database, "location")$description), selected = 1),
                                   ...
                                   selectInput("DeleteFreezer", label = NULL, choices = c("", sampleDB::CheckTable(database = database, "location")$description), selected = 1),
