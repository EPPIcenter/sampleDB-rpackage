           ...
           tabPanel("Micronix Samples",
                    ...
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        selectInput("UploadLocationMatrixLevelI", label = HTML("<h5>Level I</h5>"), width = '25%', choices = c("", sampleDB::CheckTable(database = database, "location")$level_I)),
                        selectInput("UploadLocationMatrixLevelII", label = HTML("<h5>Level II</h5>"), width = '25%', choices = c("", sampleDB::CheckTable(database = database, "location")$level_II)),
