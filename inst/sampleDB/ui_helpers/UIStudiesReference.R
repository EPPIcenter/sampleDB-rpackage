UIStudiesReference <- function(){
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("ChangeStudyShortCode", width = "47.5%", label = "Study to be modified", choices = c("", CheckTable(database = database, "study")$short_code)),
      ...
      selectInput("DeleteStudyShortCode", width = "47.5%", label = "Study to be deleted", choices = c("", CheckTable(database = database, "study")$short_code)),
